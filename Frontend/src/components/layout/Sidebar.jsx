        ...
        {menuItems.map((item) => {
          ...
          return (
            <ListItem key={item.text} disablePadding sx={{ mb: 0.5 }}>
              ...
              >
                <ListItemIcon
                  sx={{ minWidth: 40, color: isActive ? "#4f46e5" : "#6b7280" }}
                >
                  <Icon />
                </ListItemIcon>
                <ListItemText
        ...
        <ListItem disablePadding>
          <ListItemButton
            ...
            sx={{
              ...
              py: 1.5,
              backgroundColor:
                location.pathname === "/settings" ? "#eef2ff" : "transparent",
              color: location.pathname === "/settings" ? "#4f46e5" : "#6b7280",
              "&:hover": {
                backgroundColor:
                  location.pathname === "/settings" ? "#e0e7ff" : "#f9fafb",
              },
            }}
          >
            <ListItemIcon
              sx={{
                minWidth: 40,
                color:
                  location.pathname === "/settings" ? "#4f46e5" : "#6b7280",
              }}
            >
              <SettingsIcon />
            </ListItemIcon>
